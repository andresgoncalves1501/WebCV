...
$(document).ready(function() {
    ...
    $.ajax({
        type: 'GET',
        url: '../descobrirDocumentoFullTemplateEmpresa',
        success: function(data) {
            console.log("data do controller TEMPLATEEMPRESA - " + data);
            ...
            if (data[1] == "Full_cv_livre") {
                ...
                $.ajax({
                    type: 'GET',
                    url: '../preencherDocumentoFullTemplateEmpresa',
                    success: function(data2) {
                        console.log("Entrou no preencherDocumentoFull TEMPLATE empresa")
                        ...
                        $.ajax({
                            ...
                            error: function(dataQQ) { 
                       //         console.log("pdf lollllllllllllllllll") 
                    ...
                    error: function(data) { console.log("preencherDocumentoFullTemplateEmpresa deu erro") }
                })
                ...
                $.ajax({
                    type: 'GET',
                    url: '../preencherDocumentoFullPersTemplateEmpresa',
                    success: function(data3) {
                        console.log("Entrou no preencherDocumentoFullPersEmpresa TEMPLATE")
                    ...
                    error: function(data) { console.log("preencherDocumentoFullPersEmpresa deu erro") }
                })
            }
        },
        error: function(data) { console.log("descobrirDocumentoFullEmpresa deu erro") }
    })
